...
public class ZReadParamsTask extends OrderTask {
    ...
    public void parseValue(byte[] value) {
        ...
        LogModule.i("Test flash：" + params.test.substring(7, 8));
        LogModule.i("G sensor：" + params.test.substring(6, 7));
        LogModule.i("hr：" + params.test.substring(5, 6));
        LogModule.i("reflectiveThreshold：" + params.reflectiveThreshold);
        LogModule.i("reflectiveValue：" + params.reflectiveValue);
        LogModule.i("batchYear：" + params.batchYear);
        LogModule.i("batchWeek：" + params.batchWeek);
        LogModule.i("speedUnit：" + params.speedUnit);
