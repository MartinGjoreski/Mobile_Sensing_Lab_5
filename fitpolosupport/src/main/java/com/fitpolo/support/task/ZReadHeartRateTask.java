...
public class ZReadHeartRateTask extends OrderTask {
    ...
    public void parseValue(byte[] value) {
        ...
        LogModule.i("in ZReadHeartRateTask parseValue");
            ...
            case HEADER_HEART_RATE:
                if (heartRateCount > 0) {
                    ...
                    if (heartRateCount > 0) {
                        ...
                        LogModule.i("ZReadHeartRateTask: " + heartRateCount + " heartRateCount");
                        LogModule.i("ZReadHeartRateTask: " + heartRatesMap.size() + " heartRatesMap size");
